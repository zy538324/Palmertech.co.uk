// theme.js - Modern JS features for Palmertech WordPress theme
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('.service-card.interactive, .price-card.interactive').forEach(card => {
        card.addEventListener('mouseenter', () => card.classList.add('revealed'));
        card.addEventListener('mouseleave', () => card.classList.remove('revealed'));
    });
